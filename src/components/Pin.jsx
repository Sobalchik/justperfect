...
const Pin = ({pin: {postedBy, image, _id, destination, save}}) => {
    ...
    const alreadySaved = !!(save?.filter((item) => item.postedBy._id === user?.sub))?.length; //вот тут прикольно
                        ...
                        <div className="flex justify-between items-center gap-2 w-full">
                            ...
                            {postedBy?._id===user?.sub && (
                                <button
                                    ...
                                    type="button" className="bg-white p-2 opacity-70 hover:opacity-100 text-dark font-bold text-base rounded-3xl hover:shadow-md outlined-none">
                                    <AiTwotoneDelete/>
                                </button>
                            )}
                        </div>
